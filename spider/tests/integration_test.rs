#[cfg(test)]
mod tests {
    use spider::{SpiderState, ApiKey, SpiderApiKey, Message, Conversation, ConversationMetadata};
    use chrono::Utc;
    ...
    fn test_spider_key_permissions() {
        ...
        let limited = state.spider_api_keys.iter()
        ...
        let full = state.spider_api_keys.iter()
